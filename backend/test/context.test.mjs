...
test('MCP exposes seven read-only tools and returns compact counts, provenance and freshness', async t => {
  ...
  assert.equal(tools.length, 7); assert.ok(tools.every(tool => tool.annotations.readOnlyHint));
