...
test('MCP exposes four read-only tools and returns compact counts, provenance and freshness', async t => {
  ...
  assert.equal(tools.length, 4); assert.ok(tools.every(tool => tool.annotations.readOnlyHint));
