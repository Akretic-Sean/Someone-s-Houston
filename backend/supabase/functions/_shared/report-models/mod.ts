  ...
  return {
    ...
    async narrate(rawInput: unknown) {
      ...
      for (let attempt = 0; attempt < 2; attempt++) {
        ...
        } catch { /* One bounded retry, then facts without narrative. */ }
      }
      return {
        status: "degraded",
        data: null,
